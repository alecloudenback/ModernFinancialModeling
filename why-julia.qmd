...
This is a really simple example relating `Cession`s, `Policy`s, and `Live`s to do simple retention analysis. Retention is a measure of how much risk an insurance company holds on a policy after it's own reinsurance risk transfer (ceded amount of coverage are called "cessions").
