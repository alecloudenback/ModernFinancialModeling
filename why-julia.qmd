...
+=============+=========================================================+======================+===============+
| Python      | N/A: Python's `timeit` library doesn't calculate median | 817000.0             | 19926.0       |
+-------------+---------------------------------------------------------+----------------------+---------------+
...
: On our test machine, a scalar BSM pricing function implemented in idiomatic Julia ran in tens of nanoseconds per call after JIT warmup. Comparable R code ran in a few microseconds, and a pure-Python version (without vectorized NumPy) ran orders of magnitude slower. Exact numbers vary by hardware and implementation choices; the key point is that you can write high-level Julia and still get C-like performance. {#tbl-bsm-benchmark}
