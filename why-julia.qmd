...
[^why-julia-1]: Python first appeared in 1991. R is an implementation of S, which was created in 1976, though when to place the start of an independent R project varies (1993, 1995, and 2000 are alternate dates). The history of these languages is long and substantial changes have occurred since these dates.
...
-   Ability to directly call and use R and Python code/packages with the [`PythonCall.jl`](https://github.com/JuliaPy/PythonCall.jl) and [`RCall.jl`](https://github.com/JuliaInterop/RCall.jl) packages
