...
Two favourites for performance tuning financial models are `@code_warntype` (to ensure valuation functions stay type-stable) and `BenchmarkTools.@btime` (to confirm a refactor actually sped things up before you check it in).
