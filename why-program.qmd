...
This is supported by research at leading AI labs. In a study by Anthropic, 52 mostly junior software engineers with Python experience were given coding tasks. Half got AI assistance, half didn't [@shen2026aiskills]. Afterward, both groups took a quiz without AI and the AI users scored 17% lower. AI users completed tasks only about two minutes faster on average, a difference that wasn't statistically significant.

The most nuanced part is that *how* people used AI mattered enormously. The researchers identified six distinct interaction patterns. Users who engaged in "AI delegation" (copy-pasting without reading) or "iterative debugging" (repeatedly pasting errors back) had the lowest quiz scores. Those who adopted "conceptual inquiry" (asking how concepts work before coding) or "hybrid explanation" (asking AI to generate and explain code) maintained learning outcomes comparable to manual coders.
...
The paper, authored by Anthropic fellows Judy Hanwen Shen and Alex Tamkin, is called "How AI Impacts Skill Formation."

::: {.callout-note}
While not a primary motivation for selecting Julia as a the primary language for this book, research has indicated that Julia is a better language to use with AI tools than other languages such as Python, R, or C++ [@buscemi2023codegen]. This is because of its clear syntax, consistent design, and powerful abstractions, which make it easier for AI to understand and generate code. Additionally, Julia's strong support for multiple programming paradigms (procedural, object-oriented, functional) allows for more flexible and efficient code generation by AI. These factors contribute to a more seamless integration of AI tools in the programming workflow when using Julia.
:::
