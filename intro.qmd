...
Prior programming experience is *not* required: see @sec-elements-programming introduces the basic syntax and concepts while @sec-julia-writing covers setting up your environment to follow along. For readers with background in programming, we recommend skimming @sec-elements-programming.
