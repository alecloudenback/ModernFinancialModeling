...
Prior programming experience is *not* required either: @sec-elements-programming introduces the basic syntax and concepts while @sec-julia-basics covers setting up your environment to follow along. For readers with background in programming, we recommend skimming @sec-elements-programming and reading in full the sections which have a []{.juliadots} symbol in the margin, which is our way of highlighting Julia-specific content to be aware of.
