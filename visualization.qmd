...
geo = GeoJSON.read(Downloads.download("https://raw.githubusercontent.com/codeforamerica/click_that_hood/master/public/data/united-states.geojson"))
...
fig = Figure()
ax = Axis(fig[1, 1], title="Synthetic state metric", xgridvisible=false, ygridvisible=false, xlabel="", ylabel="")
