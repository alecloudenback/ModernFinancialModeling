...
-   Use a simpler scatterplot for what is essentially two dimensional data.
-   Eliminate unnecessary color and let the labels themselves sit within the plot.
-   Remove precision in the axis ticks, since decimal level precision is not necessary to tell the story.
-   Remove unnecessary plot elements including gridlines and axis without tick labels
...
-   Does funding correlate with progress? E.g. has there been faster progress in extending lifespan from avoiding cancer deaths than other diseases?
