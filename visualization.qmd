...
-   Dimensionality Reduction: PCA plots, t-SNE\index{t-SNE}`{=latex}`, and UMAP for visualizing high-dimensional data. Here we show an example how high-dimensional data can be shown on a t-SNE plot.
