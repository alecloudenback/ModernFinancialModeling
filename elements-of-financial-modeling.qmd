...
We explain what constitutes a financial model and the common uses of a model. We explore the key attributes of models, discuss different modeling approaches and their trade-offs, and some philosophy around what models are and how they capture important dynamics about the world.

## What is a Model?

A **model** is a simplified representation of reality designed to help us understand, analyze, and make predictions about complex systems. In finance, models distill the intricate web of market behaviors, economic factors, and financial instruments into tractable mathematical and computational components. We may build models for a variety of reasons, as listed in @tbl-REDCAPE.
