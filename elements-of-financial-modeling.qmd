...
Different modeling approaches come with their own trade-offs:

::: landscape
+-------------------------+-----------------------------------------------------------------------+-------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Model Type              | Description                                                           | Examples                                              | Trade-offs                                                                                                                     | Assumptions                                                                               |
+=========================+=======================================================================+=======================================================+================================================================================================================================+===========================================================================================+
| Statistical Models      | Use mathematical relationships to describe data.                      | Linear regression`\index{linear regression}`{=latex}, logistic regression`\index{logistic regression}`{=latex}                | Simplicity vs. Accuracy: Often simpler and more interpretable but may not capture complex relationships.                       | Typically rely on assumptions like linearity and normality that may not always hold true. |
+-------------------------+-----------------------------------------------------------------------+-------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Machine Learning Models`\index{machine learning}`{=latex} | Learn patterns from data using algorithms.                            | Decision trees`\index{decision trees}`{=latex}, random forests`\index{random forests}`{=latex}, neural networks`\index{neural networks}`{=latex}       | Complexity vs. Interpretability: Capture complex patterns but are often less interpretable.                                    | Performance can degrade with limited or noisy data.                                       |
|                         |                                                                       |                                                       |                                                                                                                                |                                                                                           |
|                         |                                                                       |                                                       | Overfitting`\index{overfitting}`{=latex}: Risk of overfitting, requiring careful validation and tuning. Data Requirements: Require large datasets.          |                                                                                           |
+-------------------------+-----------------------------------------------------------------------+-------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Probabilistic Models`\index{probabilistic models}`{=latex}    | Use probability distributions to model uncertainty and relationships. | Bayesian networks`\index{Bayesian networks}`{=latex}, probabilistic graphical models     | Flexibility vs. Computational Complexity: Handle uncertainty and complex relationships but require sophisticated computations. | May require assumptions about the nature of probability distributions and dependencies.   |
+-------------------------+-----------------------------------------------------------------------+-------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Simulation Models`\index{simulation models}`{=latex}       | Use computational models to simulate complex systems or scenarios.    | Monte Carlo simulations`\index{Monte Carlo simulation}`{=latex}, agent-based models`\index{agent-based models}`{=latex}           | Accuracy vs. Computational Expense: Can be computationally expensive and time-consuming.                                       | May require simplifications or assumptions for computational feasibility.                 |
|                         |                                                                       |                                                       |                                                                                                                                |                                                                                           |
...
+-------------------------+-----------------------------------------------------------------------+-------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+
| Empirical Models`\index{empirical models}`{=latex}        | Use historical data to predict future outcomes.                       | Time series forecasting`\index{time series forecasting}`{=latex}, econometric models`\index{econometric models}`{=latex}           | Data Dependence vs. Predictive Power: Rely heavily on historical data and may not perform well if patterns change.             | Performance is heavily dependent on the quality and relevance of historical data.         |
|                         |                                                                       |                                                       |                                                                                                                                |                                                                                           |
