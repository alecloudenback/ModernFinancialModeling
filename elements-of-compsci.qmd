...
[^elements-of-compsci-2]: "Big-O", so named because of the "O" in used in $O(1)$. $O(n)$, etc. The "O" refers to the "order" of growth for the function.
...
$$
\begin{align*} n^2 &+ (n \div 2) \\ (10^6)^2 &+ (10^6 \div 2) \\10^{12} &+ 5^6 \\\end{align*}
$$
