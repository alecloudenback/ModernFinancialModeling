...
In code, this translates into a function defintition that refers to itself:
...
One could imagine a possible pattern where the value of a stream of cashflows is defeined as the sum of the value of the discounted next period plus the cashflows that occur this period. 
