...
: Maximum Entropy Distributions and the conditions under which they are applicable. For example, if you know that a probability must be continuous and have a positive mean (and is non-negative), then the MED is the Exponential Distribution. {#tbl-MEDs tbl-colwidths="[50,25,25]"}
