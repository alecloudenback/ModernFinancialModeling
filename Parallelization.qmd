...
::: callout-tip
Note that Julia's compiler is able to identify vectorizable code in many cases, though some cases may benefit from a more manual hint to the compiler through macro annotations (see `?@simd` for details). See @sec-optimizing-SIMD for more.
:::
