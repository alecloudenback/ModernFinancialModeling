...
``` julia
function calculate_present_values_kernel!(
    present_values,
    cashflows, 
    discount_matrices
    )
...
@everywhere using Distributed, Random
...
# Let the workers reference the same bindings as Main
const trade_producer = Main.trade_producer
const portfolio_monitor = Main.portfolio_monitor
