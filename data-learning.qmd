...
The model is fit on log-transformed passengers to stabilise variance; exponentiating the forecast mean and interval endpoints returns predictions on the original passenger scale.
