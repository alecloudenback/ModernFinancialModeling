...
EDA`\index{exploratory data analysis (EDA)}`{=latex} helps discover patterns, relationships, and insights within the data. You can perform the following analyses, though this is not an exhaustive list:
...
Hyperparameters`\index{hyperparameters}`{=latex} control how models learn. You can use techniques like the following to tune hyperparameters:
