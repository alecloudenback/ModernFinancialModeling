...
w_opt = value.(w)
# Print results
@show "Optimal minimum variance portfolio weights:"
for (i, w_i) in enumerate(w_opt)
    @show ("Asset ", i, ": ", round(w_i, digits=4))
end
```
...
w_opt = value.(w)
# Print results
@show "Optimal portfolio weights with RBC-adjusted returns:"
for (i, w_i) in enumerate(w_opt)
    @show ("Asset ", i, ": ", round(w_i, digits=4))
end
```
...
@show "Optimal Portfolio Weights, Expected Portfolio Return, Portfolio Volatility:", ret, vol
for (i, w_i) in enumerate(w_opt)
    @show ("Asset ", i, ": ", round(w_i, digits=4))
end
```
...
w_opt = value.(w)
# Print results
@show "Optimal risk parity portfolio weights:"
for (i, w_i) in enumerate(w_opt)
    @show ("Asset ", i, ": ", round(w_i, digits=4))
end
```
...
w_opt = value.(w)
# Print results
@show "Optimal portfolio weights using Sharpe Ratio:"
for (i, w_i) in enumerate(w_opt)
    @show ("Asset ", i, ": ", round(w_i, digits=4))
end
```
