...
-   [**DifferentiationInterface.jl**](https://github.com/JuliaDiff/DifferentiationInterface.jl)`\index{DifferentiationInterface.jl}`{=latex} is a wrapper library providing a consistent API while being able exchange different backends.
