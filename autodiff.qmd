...
**Automatic differentiation**\index{automatic differentiation}`{=latex}` is essentially the practice of defining algorithmically what the derivatives of function should be. We are able to do this through a creative application of the chain rule\index{chain rule}`{=latex}`. Recall that the **chain rule** allows us to compute the derivative of a composite function using the derivatives of the component functions:
