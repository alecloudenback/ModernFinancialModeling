...
- **Jacobian:** For a vector-valued function, the Jacobian is the matrix of first partial derivatives. If \(\mathbf{f}:\mathbb{R}^n \to \mathbb{R}^m\), its Jacobian is an \(m \times n\) matrix.  
