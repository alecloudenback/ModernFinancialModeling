...
|                                   |                                           |                                                                                                                    | (Commit ID)     |
+===================================+===========================================+:===================================================================================================================+=================+
| ``` julia                         | Does not yet exist                        | Write original function which forgets to take into account the `time`.                                             | `main`\         |
...
|                                   | ```                                       |                                                                                                                    |                 |
+-----------------------------------+-------------------------------------------+--------------------------------------------------------------------------------------------------------------------+-----------------+
| "                                 | "                                         | Checkout the new branch and make it active for editing.\                                                           | `fix_function`\ |
|                                   |                                           | \                                                                                                                  | (`...58b`)      |
|                                   |                                           | **Git command:** `git checkout fix_function`                                                                       |                 |
+-----------------------------------+-------------------------------------------+--------------------------------------------------------------------------------------------------------------------+-----------------+
| "                                 | ``` julia                                 | Edit and save the changed file.                                                                                    | `fix_function`\ |
|                                   | function pv(rate,amount,time)             |                                                                                                                    | (`...58b`)      |
|                                   |     amount / (1+rate)^time                |                                                                                                                    |                 |
|                                   | end                                       |                                                                                                                    |                 |
|                                   | ```                                       |                                                                                                                    |                 |
...
: A workflow demonstrating branching, staging, committing, and merging in order to fix an incorrect function definition for a present value (`pv`) function. The branch name/commit ID shows which version you would see on your own computer/filesystem. {#tbl-git-workflow tbl-colwidths="\[30,30,30,10\]"}
:::
...
Git is a distributed VCS, meaning that copies of the repository and all it's history and content can live in multiple locations, such as on two colleauges' computer as well as a server. In this distributed model, what happens if you make a change locally?
